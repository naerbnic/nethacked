...
static const char *mail_text[] = {"Gangway!", "Look out!", "Pardon me!"};
...
STATIC_OVL void newmail(struct mail_info *info) {
  ...
  if (info->message_typ) {
    ...
    obj = hold_another_object(obj, "Oops!", (const char *)0, (const char *)0);
  }
...
/*ARGSUSED*/
void readmail(Object *otmp) { lan_mail_read(otmp); }
