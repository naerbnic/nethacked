...
bool			/* box obj was hit with spell effect otmp */ boxlock(Object *obj, Object *otmp) {
	bool res = 0;
...
/* returns true if something happened */
bool			/* Door/secret door was hit with spell effect otmp */ doorlock(Object *otmp, int x, int y) {
