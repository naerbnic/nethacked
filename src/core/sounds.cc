...
void dosounds() {
  ...
  if (level.flags.has_court && !rn2(200)) {
    static const char *const throne_msg[4] = {
        "the tones of courtly conversation.", "a sceptre pounded in judgment.",
      ...
      if ((mtmp->data->mlet == S_ANT && is_flyer(mtmp->data)) &&
        ...
        switch (rn2(2) + hallu) {
          ...
          case 1:
            ...
            break;
          case 2:
            You_hear("bees in your %sbonnet!", uarmh ? "" : "(nonexistent) ");
            break;
        }
        return;
      }
      ...
      if (is_undead(mtmp->data) && mon_in_room(mtmp, MORGUE)) {
        switch (rn2(2) + hallu) {
          case 0:
            ...
            break;
          case 1:
            pline_The("%s on the back of your %s stands up.", body_part(HAIR),
                      body_part(NECK));
            break;
          case 2:
            pline_The("%s on your %s seems to stand up.", body_part(HAIR),
                      body_part(HEAD));
            break;
        }
        return;
  ...
  if (level.flags.has_shop && !rn2(200)) {
    ...
    if (tended_shop(sroom) &&
      ...
      static const char *const shop_msg[3] = {
          "someone cursing shoplifters.", "the chime of a cash register.",
  ...
  switch (ptr->msound) {
    ...
    case MS_VAMPIRE: {
      ...
      if (mtmp->mtame) {
        if (kindred) {
          ...
          sprintf(verbuf, "%s%s", nightchild ? "Child of the night, " : "",
                  midnight()
        ...
        static const char *const vampmsg[] = {
            ...
            "I vant to suck your %s!", "I vill come after %s without regret!",
        ...
        if (kindred)
          ...
          sprintf(
              verbuf, "%s! Your silver sheen does not frighten me!",
              youmonst.data == &mons[PM_SILVER_DRAGON] ? "Fool" : "Young Fool");
          verbl_msg = verbuf;
        } else {
    ...
    case MS_BARK:
      if (flags.moonphase == FULL_MOON && night()) {
        ...
        if (mtmp->mtame && (mtmp->mconf || mtmp->mflee || mtmp->mtrapped ||
    ...
    case MS_ARREST:
      if (mtmp->mpeaceful)
        ...
        static const char *const arrest_msg[3] = {
            "Anything you say can be used against you.", "You're under arrest!",
    ...
    case MS_SOLDIER: {
      ...
      verbl_msg =
          mtmp->mpeaceful ? soldier_pax_msg[rn2(3)] : soldier_foe_msg[rn2(3)];
    } break;
    case MS_RIDER:
...
static int dochat() {
  ...
  tx = player.ux + player.dx;
  ty = player.uy + player.dy;
  mtmp = m_at(tx, ty);
