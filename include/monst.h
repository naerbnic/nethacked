...
struct Monster {
  ...
  short movement; /* movement points (derived from permonst definition and added
                     effects */
...
#define STRAT_GOALY(s) ((xchar)((s & STRAT_YMASK) >> 8))
  ...
  char *name() { return (((char *)mextra) + mxlth); }

  Object *weapon() const { return mw; }

  void ResetWeapon() { mw = 0; }

  bool dead() const { return mhp < 1; }
};
