...
#define NO_DFNS \
  { 0, 0, 0, 0 } /* no defense */
#define NO_CARY \
  { 0, 0, 0, 0 } /* no carry effects */
#define DFNS(c) \
  { 0, c, 0, 0 }
#define CARY(c) \
  { 0, c, 0, 0 }
#define PHYS(a, b) \
  { 0, AD_PHYS, a, b } /* physical */
#define DRLI(a, b) \
  { 0, AD_DRLI, a, b } /* life drain */
#define COLD(a, b) \
  { 0, AD_COLD, a, b }
#define FIRE(a, b) \
  { 0, AD_FIRE, a, b }
#define ELEC(a, b) \
  { 0, AD_ELEC, a, b } /* electrical shock */
#define STUN(a, b) \
  { 0, AD_STUN, a, b } /* magical attack */

STATIC_OVL Artifact artilist[] = {
#endif                 /* MAKEDEFS_C */
    ...
    A("", STRANGE_OBJECT, 0, 0, 0, NO_ATTK, NO_DFNS, NO_CARY, 0, A_NONE, NON_PM,
      NON_PM, 0L),
    ...
    A("Cleaver", BATTLE_AXE, SPFX_RESTR, 0, 0, PHYS(3, 6), NO_DFNS, NO_CARY, 0,
      A_NEUTRAL, PM_BARBARIAN, NON_PM, 1500L),
    A("Grimtooth", ORCISH_DAGGER, SPFX_RESTR, 0, 0, PHYS(2, 6), NO_DFNS,
      NO_CARY, 0, A_CHAOTIC, NON_PM, PM_ORC, 300L),
    /*
     *	Orcrist and Sting have same alignment as elves.
     */
    A("Orcrist", ELVEN_BROADSWORD, SPFX_DFLAG2, 0, M2_ORC, PHYS(5, 0), NO_DFNS,
      NO_CARY, 0, A_CHAOTIC, NON_PM, PM_ELF, 2000L),
    ...
    A("Grayswandir", SILVER_SABER, (SPFX_RESTR | SPFX_HALRES), 0, 0, PHYS(5, 0),
      NO_DFNS, NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 8000L),
     ...
     */
    A("Vorpal Blade", LONG_SWORD, (SPFX_RESTR | SPFX_BEHEAD), 0, 0, PHYS(5, 1),
      NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 4000L),
    /*
     ...
     */
    A("Snickersnee", KATANA, SPFX_RESTR, 0, 0, PHYS(0, 8), NO_DFNS, NO_CARY, 0,
      A_LAWFUL, PM_SAMURAI, NON_PM, 1200L),
    ...
    A("The Orb of Detection", CRYSTAL_BALL,
      ...
      NO_ATTK, NO_DFNS, CARY(AD_MAGM), INVIS, A_LAWFUL, PM_ARCHEOLOGIST, NON_PM,
      2500L),
    A("The Heart of Ahriman", LUCKSTONE, (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL),
      SPFX_STLTH, 0,
      /* this stone does double damage if used as a projectile weapon */
      PHYS(5, 0), NO_DFNS, NO_CARY, LEVITATION, A_NEUTRAL, PM_BARBARIAN, NON_PM,
      2500L),
    A("The Sceptre of Might", MACE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_DALIGN), 0, 0, PHYS(5, 0),
      NO_DFNS, CARY(AD_MAGM), CONFLICT, A_LAWFUL, PM_CAVEMAN, NON_PM, 2500L),
...
A("The Palantir of Westernesse",	CRYSTAL_BALL,
    ...
    A("The Magic Mirror of Merlin", MIRROR,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_SPEAK), SPFX_ESP, 0, NO_ATTK,
      NO_DFNS, CARY(AD_MAGM), 0, A_LAWFUL, PM_KNIGHT, NON_PM, 1500L),
    A("The Eyes of the Overworld", LENSES,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_XRAY), 0, 0, NO_ATTK,
      NO_DFNS, CARY(AD_MAGM), ENLIGHTENING, A_NEUTRAL, PM_MONK, NON_PM, 2500L),
    A("The Mitre of Holiness", HELM_OF_BRILLIANCE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_DFLAG2 | SPFX_INTEL), 0, M2_UNDEAD,
      NO_ATTK, NO_DFNS, CARY(AD_FIRE), ENERGY_BOOST, A_LAWFUL, PM_PRIEST,
      NON_PM, 2000L),
    ...
    A("The Tsurugi of Muramasa", TSURUGI,
      ...
      PHYS(0, 8), NO_DFNS, NO_CARY, 0, A_LAWFUL, PM_SAMURAI, NON_PM, 4500L),

#ifdef TOURIST
    A("The Platinum Yendorian Express Card", CREDIT_CARD,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_DEFN),
      (SPFX_ESP | SPFX_HSPDAM), 0, NO_ATTK, NO_DFNS, CARY(AD_MAGM), CHARGE_OBJ,
      A_NEUTRAL, PM_TOURIST, NON_PM, 7000L),
#endif
    ...
    A("The Eye of the Aethiopica", AMULET_OF_ESP,
      ...
      NO_ATTK, NO_DFNS, CARY(AD_MAGM), CREATE_PORTAL, A_NEUTRAL, PM_WIZARD,
      NON_PM, 4000L),
